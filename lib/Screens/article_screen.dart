import 'package:jurnal_artikel/Providers/article_prov.dart';
import 'package:jurnal_artikel/Screens/detail_screen.dart';
...
class _ArticleScreen extends State<ArticleScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('SETIADJIE BHASKARA-191011400837'),
      ),
